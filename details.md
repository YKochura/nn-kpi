...
.center[
.circle.width-40[![](figures/details/ykochura.jpg)]
]
...
Цей курс познайомить Вас з фундаментальними техніками та алгоритмами глибокого навчання та дозволить отримати практичний досвiд:
  - Використання нейронних мереж (повнозв’язні, згорткові, графові шари, механізм уваги та трансформери, пряме та зворотне поширення, активацiйнi функцiї, …)
---
...
# Опис
Цей курс познайомить Вас з фундаментальними техніками та алгоритмами глибокого навчання та дозволить отримати практичний досвiд:
  - .inactive[Використання нейронних мереж (повнозв’язні, згорткові, графові шари, механізм уваги та трансформери, пряме та зворотне поширення, активацiйнi функцiї, …)]
...
Цей курс познайомить Вас з фундаментальними техніками та алгоритмами глибокого навчання та дозволить отримати практичний досвiд:
  - .inactive[Використання нейронних мереж (повнозв’язні, згорткові, графові шари, механізм уваги та трансформери, пряме та зворотне поширення, активацiйнi функцiї, …)]
  - .inactive[Тренування нейронних мереж (iнiцiалiзацiя, оптимiзацiя, регуляризацiя, вибiр моделі, …)]
  - Управлiння проєктами (збiр та анотацiя даних, подiл датасету, збiльшення даних)
...
Усі навчальні матеріали будуть розміщуватись на цій вебсторінці:<br>  [https://courses-cs-kpi.github.io/nn-24sp/](https://courses-cs-kpi.github.io/nn-24sp/)
...
.kol-1-2[
[.center.width-85[![](figures/details/dml2.png)]](https://github.com/dml-book/dml/releases/download/v0.1.1/main.pdf)
.center[Безкоштовно]
  ]
]
